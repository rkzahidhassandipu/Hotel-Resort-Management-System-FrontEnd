...
export function RoomActions({
  ...
  return (
    <DropdownMenu>
      ...
      <DropdownMenuContent
        align="end"
        className="bg-[#1A1B21] border-white/8 text-white min-w-[180px]"
      >
        <DropdownMenuSub>
        ...
        >
          <Wrench className="h-3.5 w-3.5 mr-2 text-white/40" />
          Edit Room
        </DropdownMenuItem>
        <DropdownMenuItem
          ...
          className="text-white/70 text-xs cursor-pointer focus:bg-white/5 focus:text-white"
        >
          <Image className="h-3.5 w-3.5 mr-2 text-white/40" />
          Manage Images
        </DropdownMenuItem>
        <DropdownMenuItem
          onClick={() => onPricingClick(room)}
          className="text-white/70 text-xs cursor-pointer focus:bg-white/5 focus:text-white"
        >
          <DollarSign className="h-3.5 w-3.5 mr-2 text-white/40" /> Add Pricing
          Rule
        </DropdownMenuItem>
        <DropdownMenuItem
