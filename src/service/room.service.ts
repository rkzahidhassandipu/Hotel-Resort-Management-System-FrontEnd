...
export const roomService = {
  ...
  create: (data: CreateRoomPayload) => httpClient.post('/rooms', data),
  update: (id: string, data: CreateRoomPayload) => httpClient.put(`/rooms/${id}`, data),
  ...
  getStatuses: () => httpClient.get('/rooms/statuses'),
